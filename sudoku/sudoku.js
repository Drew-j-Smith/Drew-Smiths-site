...
/**
* @param {Int32Array} vals
* @returns {any[]}
*/
export function complete_sudoku(vals) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray32ToWasm0(vals, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.complete_sudoku(retptr, ptr0, len0);
